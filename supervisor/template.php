...
<html class="no-js">
    <head>
        <title>SIWES upervision Information Management System</title>
                ...
                <a class="brand" href="#">Welcome to: I.T / SIWES Supervision Maanagement Information System</a>
					<div class="nav-collapse collapse">
						<ul class="nav pull-right">
							<?php $query= mysqli_query($con,"select * from supervisor where supervisor_id = '$session_id'")or die(mysqli_error($con));
...
<div id="myModal_student" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-footer">
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="index.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Student</a></li>

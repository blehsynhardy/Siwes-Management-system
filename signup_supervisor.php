<body id="login">
	...
	<div class="span6">
		<div class="pull-right">
			...
			<h3 class="form-signin-heading"><i class="icon-lock"></i> Sign up as Supervisor</h3>
			...
			<button name="signup_sup" class="btn btn-info" type="submit"><i class="icon-check icon-large"></i> Sign in</button>
			</form>
